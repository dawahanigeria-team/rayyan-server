...
router.route("/login").post(authController.loginWithEmailAndPassword);
...
router
  .route("/google/callback/withGoogle/:token")
  .get(authController.constinueWithGoogle);

// facebook auth constinueWithGoogle
...
router
  ...
  .get(
    ...
    authController.authThirdPartyCallback
  );
